...
public class MemberTest {
	...
	public void setUp() throws Exception {
		mem1 = new Member("Pravin", "Dahal", "12345", "prav.dahl17@gmail.com", 101);
		mem2 = new Member("Hari", "Raju", "54321", "hraju@gmail.com", 102);
		mem3 = new Member("Srikant", "Vimal", "98765", "srikvimal@gmail.com", 103);
	...
	public final void testGetFirstName() {
		...
		assertEquals("Matching First Name", "Pravin", fName);
	}
	...
	public final void testGetLastName() {
		...
		assertEquals("Matching Last Name", "Dahal", lName);
	}
	...
	public final void testGetEmailAddress() {
		...
		assertEquals("Matching email", "prav.dahl17@gmail.com", email);
	}
